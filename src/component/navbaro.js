      ...
      <nav className="navbar navbar-expand-lg fixed-top navbar-custom">
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <button className="btn btn-outline-primary LoginS" type="button" onClick={handleLoginClick}>
              Login
            </button>
            <button className="btn btn-outline-primary LoginS" type="button" onClick={handleSignupClick}>
              SignUp
            </button>
          </div>
        </div>
